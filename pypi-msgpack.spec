...
Source0  : https://files.pythonhosted.org/packages/08/4c/17adf86a8fbb02c144c7569dc4919483c01a2ac270307e2d59e1ce394087/msgpack-1.0.8.tar.gz
...
%prep
%setup -q -n msgpack-1.0.8
cd %{_builddir}/msgpack-1.0.8
pushd ..
cp -a msgpack-1.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709416956
