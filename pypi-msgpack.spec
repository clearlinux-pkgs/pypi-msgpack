...
Source0  : https://files.pythonhosted.org/packages/45/b1/ea4f68038a18c77c9467400d166d74c4ffa536f34761f7983a104357e614/msgpack-1.1.1.tar.gz
...
%prep
%setup -q -n msgpack-1.1.1
cd %{_builddir}/msgpack-1.1.1
pushd ..
cp -a msgpack-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749825587
